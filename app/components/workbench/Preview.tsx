...
export const Preview = memo(({ setSelectedElement }: PreviewProps) => {
  ...
  return (
    <div ref={containerRef} className={`w-full h-full flex flex-col relative`}>
      ...
      <div className="bg-bolt-elements-bg-depth-2 p-2 flex items-center gap-2 border-b border-bolt-elements-borderColor">
          ...
          <div className="flex items-center relative">
            ...
            {isWindowSizeDropdownOpen && (
              <>
                ...
                <div className="absolute right-0 top-full mt-2 z-50 min-w-[240px] max-h-[400px] overflow-y-auto bg-bolt-elements-bg-depth-1 dark:bg-bolt-elements-bg-depth-2 rounded-xl shadow-2xl border border-bolt-elements-borderColor overflow-hidden">
                  ...
                  {WINDOW_SIZES.map((size) => (
                    <button
                      key={size.name}
                      className="w-full px-4 py-3.5 text-left text-bolt-elements-textPrimary text-sm whitespace-nowrap flex items-center gap-3 group hover:bg-bolt-elements-item-backgroundActive bg-bolt-elements-bg-depth-1 dark:bg-bolt-elements-bg-depth-2"
                      onClick={() => {
      ...
      <div className="flex-1 border-t border-bolt-elements-borderColor flex justify-center items-center overflow-auto">
        ...
        >
          {activePreview ? (
            ...
            <div className="flex w-full h-full justify-center items-center bg-bolt-elements-bg-depth-1 text-bolt-elements-textPrimary">
