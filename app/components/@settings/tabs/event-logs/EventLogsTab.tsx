...
export function EventLogsTab() {
  ...
  const exportAsPDF = () => {
    try {
      ...
      // Add subtitle with octotask.dev
      doc.setFontSize(12);
      doc.setFont('helvetica', 'normal');
      doc.text('octotask.dev - AI Development Platform', margin, 45);
      yPos = 70;
      ...
      for (let i = 1; i <= totalPages; i++) {
        ...
        // Add footer text
        doc.text('Generated by octotask.dev', margin, doc.internal.pageSize.getHeight() - 10);
